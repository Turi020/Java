...
public class Würfelspiel {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the Dice game! Please ente 1 to start.");
                ...
                case 1:
                    ...
                    if (pipTotalComputer > pipTotalPerson) {
                        ...
                        switch (pointsDifference) {
                            case 1:
                                String pointAmountText = " points";
                                System.out.println("Computer won by " + pointsDifference + pointAmountText + ".");
                                winsComputer += 1;
                                break;
                            default:
